...
class _AxesExtMixin:
    ...
    def get_dashed_line(self, x1, y1, x2, y2, creation: float = 0, z: float = 0, **styling_kwargs):
    ...
    def get_horizontal_line(self, x, y_val, creation: float = 0, z: float = 0, **styling_kwargs):
    ...
    def add_asymptote(self, value, direction='vertical', creation: float = 0, z: float = 0, **styling_kwargs):
    ...
    def add_horizontal_line(self, y, start=None, end=None, creation: float = 0, z: float = 1, **styling_kwargs):
        """Draw a horizontal dashed guide line at *y*."""
        return self._add_guide_line(y, 'horizontal', start, end, creation, z, styling_kwargs)

    def add_vertical_line(self, x, start=None, end=None, creation: float = 0, z: float = 1, **styling_kwargs):
    ...
    def add_crosshair(self, func, x_start, x_end, start: float = 0, end: float = 1,
                       creation: float = 0, z: float = 3, easing=easings.smooth, **styling_kwargs):
    ...
    def add_vertical_span(self, x0, x1, creation: float = 0, z: float = -1, **styling_kwargs):
        """Shade a vertical band between x0 and x1 (math coords)."""
        return self._add_span(x0, x1, True, creation, z, styling_kwargs)

    def add_horizontal_span(self, y0, y1, creation: float = 0, z: float = -1, **styling_kwargs):
    ...
    def add_reference_band(self, lo, hi, axis='y', creation: float = 0, z: float = -1, **styling_kwargs):
    ...
    def get_vertical_lines(self, func, x_values, creation: float = 0, z: float = 0, **styling_kwargs):
    ...
    def get_horizontal_lines(self, y_values, x_start=None, x_end=None, creation: float = 0, z: float = 1, **kwargs):
    ...
    def coords_label(self, x, y, text=None, creation: float = 0, z: float = 0, **styling_kwargs):
    ...
    def add_residual_lines(self, x_data, y_data, creation: float = 0, z: float = 1, **styling_kwargs):
