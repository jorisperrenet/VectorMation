...
class _VObjectEffectsMixin:
    ...
    def add_background(self, color='#000000', opacity: float = 0.5, padding: float = 20, creation: float = 0, z: float = -1):
    ...
    def add_label(self, text, direction=UP, buff: float = 20, font_size=None, follow=False, creation: float = 0, **kwargs):
