...
phase_axes = Axes(x_range=(-200, 200), y_range=(-600, 600),
                  x=1050, y=200, plot_width=700, plot_height=600,
...
# Small graph in top-left showing x(t)
time_axes = Axes(x_range=(0, T), y_range=(-200, 200),
                 x=200, y=50, plot_width=500, plot_height=200,
...
# ── Title & equation ─────────────────────────────────────────────────
title = Text(text='Damped Spring-Mass System', x=960, y=870,
             font_size=36, fill='#fff', stroke_width=0, text_anchor='middle',
             creation=0)
title.fadein(0, 0.5)

eq_text = Text(text="x'' + μx' + kx = 0", x=960, y=920,
