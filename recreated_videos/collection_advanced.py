...
circ1.stagger('fadein', delay=0.1, start=0.5, end=1.5)
...
rad1.stagger('fadein', delay=0.08, start=0.5, end=1.3)
...
orb.stagger('fadein', delay=0.1, start=0.5, end=1.2)
...
sp.stagger('fadein', delay=0.08, start=0.5, end=1.3)
...
flp.stagger('fadein', delay=0.08, start=0.5, end=1.3)
...
conn.stagger('fadein', delay=0.08, start=0.5, end=1.3)
...
conv.stagger('fadein', delay=0.05, start=6.3, end=7)
...
div1.stagger('fadein', delay=0.05, start=6.3, end=7)
...
scat.stagger('fadein', delay=0.05, start=6.3, end=7)
...
gath.stagger('fadein', delay=0.05, start=6.3, end=7)
gath.gather_to(cx=350, cy=700, start=8, end=9)
gath.fadeout(11.0, 11.5)
v.add(gath)

# --- show_one_by_one ---
lbl11 = Text(text='show_one_by_one', x=960, y=560, font_size=22,
             fill='#888', stroke_width=0, text_anchor='middle', creation=6.3)
...
obo.show_one_by_one(start=7, end=9)
...
ss.stagger('fadein', delay=0.05, start=12.3, end=13)
...
sr.stagger('fadein', delay=0.05, start=12.3, end=13)
...
sc.stagger('fadein', delay=0.05, start=12.3, end=13)
sc.stagger_color(colors=('#FF0000', '#FFFF00'), start=13.5, end=15)
sc.fadeout(17.0, 17.5)
v.add(sc)

# --- cascade_fadein ---
lbl16 = Text(text='cascade_fadein', x=350, y=560, font_size=22,
             fill='#888', stroke_width=0, text_anchor='middle', creation=12.3)
...
cf.cascade_fadein(start=13, end=14.5)
cf.fadeout(17.0, 17.5)
v.add(cf)

# --- cascade_scale ---
lbl17 = Text(text='cascade_scale', x=960, y=560, font_size=22,
             fill='#888', stroke_width=0, text_anchor='middle', creation=12.3)
...
cs.stagger('fadein', delay=0.05, start=12.3, end=13)
cs.cascade_scale(factor=0.5, start=14, end=15.5)
...
sfo.stagger('fadein', delay=0.05, start=12.3, end=13)
...
rc.stagger('fadein', delay=0.05, start=18.3, end=19)
...
sha.stagger('fadein', delay=0.05, start=18.3, end=19)
...
snk.stagger('fadein', delay=0.05, start=18.3, end=19)
...
shp.stagger('fadein', delay=0.05, start=18.3, end=19)
...
lab.stagger('fadein', delay=0.08, start=18.3, end=19)
...
aa.stagger('fadein', delay=0.05, start=24.3, end=25)
...
aag.stagger('fadein', delay=0.05, start=24.3, end=25)
...
we.stagger('fadein', delay=0.05, start=24.3, end=25)
we.wave_effect(start=25.5, end=28, amplitude=50)
we.fadeout(29.0, 29.5)
v.add(we)

# --- fade_in_one_by_one ---
lbl28 = Text(text='fade_in_one_by_one', x=350, y=560, font_size=22,
             fill='#888', stroke_width=0, text_anchor='middle', creation=24.3)
...
fio.fade_in_one_by_one(start=25, end=27)
...
daa.stagger('fadein', delay=0.05, start=24.3, end=25)
...
sc2.stagger('fadein', delay=0.1, start=30.3, end=31)
...
hl.stagger('fadein', delay=0.1, start=30.3, end=31)
...
og.stagger('fadein', delay=0.05, start=30.3, end=31)
...
cg.stagger('fadein', delay=0.1, start=30.5, end=31.5)
