...
# Lighten demo
base_color = '#FC6255'
lighten_label = Text(text='lighten()', x=350, y=180, font_size=28,
...
# Darken demo
darken_label = Text(text='darken()', x=350, y=390, font_size=28,
                    fill='#AAAAAA', stroke_width=0, text_anchor='middle', creation=6.0)
...
for i, amt in enumerate(darken_amounts):
    ...
    r = Rectangle(100, 80, x=140 + i * 115 - 50, y=430,
                  fill=col, fill_opacity=1, stroke_width=0, rx=8, ry=8, creation=6.0)
    r.fadein(6.6 + i * 0.08, 7.1 + i * 0.08)
    r.fadeout(8.5, 9.0)
    canvas.add(r)
    lbl = Text(text=f'{amt:.0%}', x=140 + i * 115, y=535,
               font_size=16, fill='#666666', stroke_width=0, text_anchor='middle', creation=6.0)
...
comp_label = Text(text='complementary()', x=1200, y=180, font_size=28,
                  fill='#AAAAAA', stroke_width=0, text_anchor='middle', creation=6.0)
...
comp_names = ['RED', 'BLUE', 'GREEN', 'ORANGE']
for i, (col, name) in enumerate(zip(comp_colors, comp_names)):
...
orig_label = Text(text='Original', x=900, y=275, font_size=18,
...
comp_res_label = Text(text='Complement', x=900, y=375, font_size=18,
                      fill='#666666', stroke_width=0, text_anchor='end', creation=6.0)
comp_res_label.fadein(7.0, 7.4)
comp_res_label.fadeout(8.5, 9.0)
canvas.add(comp_res_label)

# Saturate / Desaturate demo
