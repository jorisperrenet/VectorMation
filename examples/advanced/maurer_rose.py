...
# ── Labels ───────────────────────────────────────────────────────────
title = TexObject(r'Maurer Rose', x=960, y=50, font_size=42,
                  fill='#fff', stroke_width=0, anchor='center', creation=0)
title.fadein(0, 0.5)

params = TexObject(rf'$n = {n}, \quad d = {d}^\circ$', x=960, y=100,
                   font_size=24, fill='#fff', stroke_width=0,
                   anchor='center', creation=0)
params.fadein(0.3, 0.8)

formula = TexObject(r'$r = \sin(n\theta), \quad \text{step} = d^\circ$',
                    x=960, y=1020, font_size=22, fill='#fff', stroke_width=0,
                    anchor='center', creation=0)
...
params2 = TexObject(rf'$n = {n}, \quad d = 29^\circ$', x=960, y=100,
                    font_size=24, fill='#fff', stroke_width=0,
                    anchor='center', creation=0)
