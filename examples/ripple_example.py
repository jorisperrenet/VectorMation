...
dot.fadein(0, 0.5)
ripple1 = dot.ripple(start=1, count=3, duration=1.5, max_radius=150, color='#FFFF00')

# Ripple on a text
txt = Text(text='Click!', x=960, y=450, font_size=60, fill='#83C167',
           stroke_width=0, text_anchor='middle')
txt.fadein(0, 0.5)
ripple2 = txt.ripple(start=2, count=4, duration=2, max_radius=200, color='#83C167')

# Ripple on a rectangle
rect = Rectangle(150, 100, x=1400, y=400, fill='#58C4DD', fill_opacity=0.7)
rect.fadein(0, 0.5)
ripple3 = rect.ripple(start=3, count=5, duration=2, max_radius=180, color='#58C4DD')
